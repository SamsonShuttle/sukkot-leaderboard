    ...
    <main className="projector-view">
      ...
      <header className="projector-header">
        ...
        <div className="header-actions">
          ...
          <a className="icon-button" href="#/dashboard" title="Open full data dashboard"><ChartNoAxesCombined /></a>
          <button className="icon-button" onClick={enterFullscreen} title="Enter fullscreen"><Maximize2 /></button>
          <a className="icon-button" href="#/organizer" title="Organizer controls"><Settings2 /></a>
        </div>
      </header>
