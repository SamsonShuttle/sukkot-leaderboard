...
- Treat the active trip day as a recording input only. Current scores and public analytics always cover the complete active event; day-grouped history preserves daily closing totals.
